    ...
    <div class="contact-banner-left-panel">
        ...
        <div class="banner-content">
            ...
            <table>
                ...
                <tr>
                    <td>Kartavaya:</td>
                    <td><span class="banner-table-contact-text">Kartavaya@gmail.com</span></td>
                </tr>
                <tr>
                    <td>Hitesh:</td>
                    <td><span class="banner-table-contact-text">Hitesh@gmail.com</span></td>
                </tr>
                <tr>
                    <td>Divyansh:</td>
                    <td><span class="banner-table-contact-text">Divyansh@gmail.com</span></td>
                </tr>
            </table>
        </div>
    </div>
